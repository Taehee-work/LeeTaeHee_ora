...
<div id="container">
	...
	<div class="location_area member">
		<div class="box_inner">
			...
			<p class="location">회원 <span class="path">/</span>회원등록</p>
				...
				<form action="/mypage/insert" class="regForm" method="post">
					<fieldset>
						...
						<ul class="reg_list">
							...
							<input value="0" name="point" type="hidden" class="w100p" placeholder="" />
							<input value="1" name="enabled" type="hidden" class="w100p" placeholder=""/>
							<input value="ROLE_USER" name="levels" type="hidden" class="w100p" placeholder="" />
		...
		$.ajax({
			...
			success:function(result){
				if(result=='1'){//중복아이디가 존재할때
					...
					$("#validation_idcheck").text("사용 가능한 아이디입니다");
